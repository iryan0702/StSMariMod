...
//        }
    ...
    public static ShaderProgram orangeShader;
    ...
    public void receivePostInitialize() {
        ...
        orangeShader = new ShaderProgram(Gdx.files.internal("mari_mod/shaders/orange/vertexShader.vs").readString(),Gdx.files.internal("mari_mod/shaders/orange/fragShader.fs").readString());

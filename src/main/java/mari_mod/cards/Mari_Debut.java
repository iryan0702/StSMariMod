...
public class Mari_Debut extends AbstractMariCard implements OnRecallCard, PurgeOnRecallCard{
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToTop(new ApplyPowerAction(m, m, new Radiance_Power(m, this.radiance), this.radiance));

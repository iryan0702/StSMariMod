...
public class Mari_Limelight extends AbstractMariCard {
    ...
    private static final int APPLIED_RADIANCE = 1;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new Limelight_Power(p, this.radiance), this.radiance));
    }

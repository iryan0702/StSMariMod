...
public class MariCustomTags {
    @SpireEnum public static AbstractCard.CardTags SPEND;
    ...
    @SpireEnum public static AbstractCard.CardTags RECOVER;

    @SpireEnum public static AbstractCard.CardTags DRAMA;
    @SpireEnum public static AbstractCard.CardTags ENERGY;
    @SpireEnum public static AbstractCard.CardTags CORRUPT;
    @SpireEnum public static AbstractCard.CardTags DANCE;
}

...
public class MariFadingReward extends RewardItem {
    ...
    public void render(SpriteBatch sb) {
        ...
        Texture cardImg = ImageMaster.loadImage("mari_mod/images/rewards/MariFadingCardReward.png");

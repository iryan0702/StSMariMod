...
public class MariShiningTornadoEffect extends AbstractGameEffect {
    ...
    public MariShiningTornadoEffect(float srcX, float srcY, float destX, float destY) {
        if (img == null) {
        ...
        this.rotation = 0.0F;
        this.duration = 0.6F;
        this.color = new Color(1.0F, 0.9F, 0.0F, 0.0F);
        if (this.sY > this.dY) {

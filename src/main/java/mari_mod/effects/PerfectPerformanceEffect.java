...
public class PerfectPerformanceEffect extends AbstractGameEffect {
    ...
    public void update() {
        if (this.duration == START_TIME) {
            ...
            AbstractDungeon.effectsQueue.add(new MariSpotlightEffect(this.duration,Settings.WIDTH/2f, Settings.WIDTH, true, 1.5f, new Color(1.0f, 0.8f, 0.9f, 0.5f)));
        }
        ...
        if(this.duration < MUSIC_START_FADE_IN && this.duration >= 0){

...
import mari_mod.actions.MariCharacterDevelopmentPowerCheckAction;
...
public class Character_Development_Power extends AbstractPower
{
    ...
    public void onSpecificTrigger() {
        ...
        AbstractDungeon.actionManager.addToTop(new MariCharacterDevelopmentPowerCheckAction(this.amount,this));

...
public class MariCollectThoughtsOldAction extends AbstractGameAction {
    public static final Logger logger = LogManager.getLogger(MariCollectThoughtsOldAction.class.getName());
    ...
    public MariCollectThoughtsOldAction(boolean upgraded) {
